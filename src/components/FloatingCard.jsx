...
export default function FloatingCard({ children, className = "", delay = 0 }) {
    return (
        <motion.div
            ...
            className={`relative bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-slate-100 ${className}`}
        >
